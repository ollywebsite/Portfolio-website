  ...
  toggleButtons.forEach((button) => {
    button.addEventListener("click", function () {
      ...
      if (this.classList.contains("toggle-btn1")) {
        loremParagraph = this.closest(".secondpageright").querySelector(".lorem1");
      } else if (this.classList.contains("toggle-btn2")) {
        loremParagraph = this.closest(".secondpageright").querySelector(".lorem2");
      } else if (this.classList.contains("toggle-btn3")) {
        loremParagraph = this.closest(".secondpageright").querySelector(".lorem3");
      }
  ...
  const testimonials = [
    {
        ...
        author: "../Andy Smith.png",
        role: "../Founder, Apple.png"
    },
    {
...
const testimonialImage = document.getElementById("testimonialImage").querySelector("img");
const testimonialText = document.getElementById("testimonialText").querySelector("img");
const testimonialAuthor = document.getElementById("testimonialAuthor").querySelector("img");
const testimonialRole = document.getElementById("testimonialRole").querySelector("img");
...
function updateTestimonial() {
    ...
    testimonialText.src = currentTestimonial.text;
    testimonialAuthor.src = currentTestimonial.author;
    testimonialRole.src = currentTestimonial.role;
}
